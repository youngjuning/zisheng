# @zisheng/eslint-config-react-typescript

## Install

```sh
yarn add -D @zisheng/eslint-config-react-typescript eslint prettier typescript @zisheng/prettier-config lint-staged yorkie
```
