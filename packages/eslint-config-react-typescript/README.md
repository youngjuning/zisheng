# @youngjuning/eslint-config-react-typescript

## Install

```sh
yarn add -D @youngjuning/eslint-config-react-typescript eslint prettier typescript @youngjuning/prettier-config lint-staged yorkie
```
